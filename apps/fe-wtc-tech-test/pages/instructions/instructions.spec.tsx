      ...
      <div>
        <main>
          ...
          <ol>
            <li>
              <details>
                ...
                <pre>
                  <p>
                    As a user, I want to see the list of all movies, so I can see what is available.
                  </p>
                </pre>
              </details>
            </li>
            <li>
              <details>
                ...
                <pre>
                  <p>
                    As a user, I want to filter the list of all movies available, so I can better decide based on my preference. I want to be able to filter by:
                  </p>
                  <ul>
                    <li>
                      Type
                  ...
                  <p>
                    Sometimes the list of some elements is too long (i.e. actors, directors etc.), so as a user, I want these lists to be shorten. I want to be able to click on a "See more" button to see the rest.
                  </p>
                </pre>
              </details>
            </li>
          ...
          <ul>
            ...
            <li>
              Your solution should include MEANINGFUL tests which test some or all the application's logic (you can also add E2E tests with Cypress if you like and if you want to impress us. fe-wtc-tech-test-e2e is there for this reason, but it is not required). Snapshots tests are fine for presentational components, but they might not be enough in other scenarios. We want to see how you test application logic, we give for granted that you know how to write snapshots tests.
            </li>
            <li>
              if you diverge from the default behavior or this repo, you should add at the top or the readme file the new instructions. Please be clear.
            </li>
            <li>
              <p>
                In order to speed up development, if you'd like, you can use, change or extend components already present in the ui library. Those we have included, are just a wrapper around the Material UI one, nothing more. You can import them like:
              </p>
              <p>
                <code>
          ...
          <details>
            ...
            <pre>
              <ul>
                <li>
                  If your solution meets accessibility standards
                </li>
                <li>
